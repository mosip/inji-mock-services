...
public class DriverValidationService implements ValidationService {
    ...
    private void loadConfig() {
        try {
            InputStream in = getClass().getClassLoader().getResourceAsStream("validation/driver.json");
            if (in == null) {
                throw new RuntimeException("Config file not found: validation/driver.json");
            }
            ...
            throw new RuntimeException("Failed to load config for DriverValidationService", e);
        }
    }
    ...
    public void validate(Map<String, Object> data) {
        loadConfig();
        System.out.println("Called from DriverValidationService");
        verifyFieldService.verifyRequired(data, requiredFields);
        verifyFieldService.verify(data, fields);
        System.out.println("DriverValidationService: Validation Passed!");
    }
}
