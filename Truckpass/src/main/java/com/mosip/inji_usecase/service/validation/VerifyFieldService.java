    ...
    public void verifyRequired(Map<String, Object> data, Set<String> required_fields) {
        for (String field : required_fields) {
            ...
            if (value == null || (value instanceof String && ((String) value).trim().isEmpty())) {
                throw new IllegalArgumentException("Required field '" + field + "' cannot be empty");
            }
        }
            ...
            try {
                for (Map.Entry<String, Object> field_param : field_params.entrySet()) {
                    ...
                    switch (type) {
                        ...
                        // Do nothing as this has to be handled with parameters different from what's provided in function verify, so it will be called before calling verify
                        case REQUIRED -> {}
                    }
                }
                System.out.println();
