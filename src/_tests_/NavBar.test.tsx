...
import NavBar from '../components/NavBar'; // <- adjust if your NavBar lives in /commans
...
describe('NavBar', () => {
  ...
  test('changes language and closes dropdown on selection', async () => {
    ...
    const frenchButton = screen.getByText('Française');
...
// Test3: Verifies that selecting a language (Française) updates the display and closes the dropdown
