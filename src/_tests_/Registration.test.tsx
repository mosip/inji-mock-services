...
describe('Registration Component', () => {
  ...
  test('renders personal information section correctly', () => {
    ...
    expect(screen.getByDisplayValue('registration.DfullName')).toBeInTheDocument();
    expect(screen.getByDisplayValue('198765432123')).toBeInTheDocument();
    expect(screen.getByDisplayValue('registration.Dgender')).toBeInTheDocument();
    expect(screen.getByDisplayValue('registration.Demail')).toBeInTheDocument();
    expect(screen.getByDisplayValue('+91 9876543210')).toBeInTheDocument();
    expect(screen.getByDisplayValue('registration.Dcity')).toBeInTheDocument();
  });
  ...
  // Commented out due to shareViaInjiVerify UI block being commented out - kept as-is
  /*
