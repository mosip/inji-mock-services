...
import OtpVerificationPage from './pages/requestTruckPass/OtpVerificationPage.tsx';
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route
          path={'/truckpasslogin'}
          element={<DriverRegistrationMainLayout><LoginPage /></DriverRegistrationMainLayout>}
        />
        <Route
          path={'/truckpass-otp-verification'}
          element={<DriverRegistrationMainLayout><OtpVerificationPage /></DriverRegistrationMainLayout>}
        />
        <Route path="*" element={<Navigate to="/landingPage" replace />} />
      </Routes>
    </BrowserRouter>
