...
import { TruckPassCard } from '../../components/TruckPassVerificationCard';
...
import disableDownloadIcon from '../../assets/disable_download_button.png';
...
export const Dashboard: React.FC<DashboardProps> = ({ }) => {
    ...
    const downloadRequestPass = () => {
        setShowRequestPass(true);
    };
                                ...
                                {tableBody.map((request, id) => {
                                    ...
                                    return (
                                        <tr key={id}
                                            ...
                                            <td className={`px-12`} onClick={downloadRequestPass}>{
                                                request.status==='approved' ?
                                                <img src={downloadIcon} className={`h-5 w-5 rounded-md cursor-pointer`} />
                                                : <img src={disableDownloadIcon} className={`h-7 w-7 rounded-md cursor-default`} />
                                            }</td>
                                        </tr>
                                    )
                                })
