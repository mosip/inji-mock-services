                    ...
                    <div className="space-y-4">
                        ...
                        <form className='flex flex-col gap-y-4'>
                            <div className='space-y-1'>
                                ...
                                <input disabled value={t('registration.DfullName')} className='bg-[#FAFAFA] text-[15px] text-[#717680] p-1.5 w-full border border-[#D5D7DA] rounded-md' />
                            </div>
                            <div className="space-y-1">
                                <label className="flex items-center">
                            ...
                            <div className='space-y-1'>
                                ...
                                <input disabled value={t('registration.Dgender')} className='bg-[#FAFAFA] text-[15px] text-[#717680] p-1.5 w-full border border-[#D5D7DA] rounded-md' />
                            </div>
                            <div className='space-y-1'>
                                <label className="flex items-center">
                                ...
                                <input disabled value={t('registration.Demail')} className='bg-[#FAFAFA] text-[15px] text-[#717680] p-1.5 w-full border border-[#D5D7DA] rounded-md' />
                            </div>
                            <div className='space-y-1'>
                                <label className='flex items-center'>
                            ...
                            <div className='space-y-1'>
                                ...
                                <input disabled value={t('registration.Dcity')} className='bg-[#FAFAFA] text-[15px] text-[#717680] p-1.5 w-full border border-[#D5D7DA] rounded-md' />
                            </div>
